...
class FileSystem:
    ...
    async def read_file(self, path: str, return_metadata: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            if not validate_path(str(full_path)):
                return {"success": False, "error": "Path not allowed", "content": None, "path": None}
    ...
    async def list_directory(self, path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not path_obj.exists():
                return {"success": False, "error": "Path does not exist", "path": None, "items": None}
    ...
    async def search_files(self, path: str, pattern: str) -> Dict[str, Any]:
        ...
        try:
            full_path = self._resolve_path(path)
            if not validate_path(str(full_path)):
                return {"success": False, "error": "Path not allowed", "path": None, "matches": None}
